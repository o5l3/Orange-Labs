...
export default function Home() {
  ...
  const pillars = [
    ...
    },
    {
      icon: (
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
          <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75l2.25 2.25 4.5-4.5m0 0a9 9 0 11-12.728 0 9 9 0 0112.728 0z" />
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            ...
            <div className="flex-shrink-0 text-center lg:text-left">
              ...
              <div className="text-6xl sm:text-7xl font-bold mb-2" style={{ color: '#f97316', lineHeight: 1 }}>
                {t('home.problem_stat')}
              </div>
              <div className="text-sm mb-2" style={{ color: '#6b7280' }}>{t('home.problem_stat_label')}</div>
            </div>
            {/* Right: description */}
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold mb-5" style={{ color: '#f1f1f3', lineHeight: '1.35' }}>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {pillars.map((p) => (
              ...
              >
                ...
                <div className="text-xs font-semibold tracking-widest mb-1" style={{ color: '#f97316' }}>{p.sub}</div>
                <h3 className="text-xl font-bold mb-3" style={{ color: '#f1f1f3' }}>{p.title}</h3>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {keyFeatures.map((f) => (
              ...
              >
                ...
                <div>
                  <h3 className="text-base font-semibold mb-1.5" style={{ color: '#f1f1f3' }}>{f.title}</h3>
